...
const messages = defineMessages({
    label: {
        ...
        defaultMessage: 'Report statistics to improve XpniBlock',
        description: 'XpniBlock telemetry modal label - for accessibility'
    },
    bodyText1: {
        defaultMessage: 'The XpniBlock Team is always looking to better understand how XpniBlock is used around the ' +
            'world. To help support this effort, you can allow XpniBlock to automatically send usage information to ' +
            'the XpniBlock Team.',
    ...
    privacyPolicyLink: {
        ...
        description: 'Link to the XpniBlock privacy policy',
        id: 'gui.telemetryOptIn.privacyPolicyLink'
    },
    optInText: {
        defaultMessage: 'Share my usage data with the XpniBlock Team',
    ...
    optOutText: {
        defaultMessage: 'Do not share my usage data with the XpniBlock Team',
        description: 'Text for telemetry modal opt-in button',
