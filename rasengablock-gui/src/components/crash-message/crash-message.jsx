...
const CrashMessage = props => (
    <div className={styles.crashWrapper}>
        <Box className={styles.body}>
            ...
            <p>
                <FormattedMessage
                    defaultMessage={'We are so sorry, but it looks like XpniBlock has crashed. This bug has been' +
                        ' automatically reported to the XpniBlock Team. Please refresh your page to try' +
                        ' again.'}
