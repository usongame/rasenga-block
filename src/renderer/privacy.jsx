...
const PrivacyElement = () => (
    <div className={styles.privacyBox}>
        ...
        <i>The xpniBlock Privacy Policy was last updated: October 5, 2020</i>
        <p>
            The xpniBlock Team (&ldquo;xpniBlock&rdquo;, &ldquo;we&rdquo; or &ldquo;us&rdquo;) understands how
            ...
            (&ldquo;Information&rdquo;) we collect through our offline editor (the &ldquo;<a
                href="https://xpni.cn/docs"
                target="_blank"
                rel="noopener noreferrer"
            >xpniBlock App</a>&rdquo;), how we use, process, and share it, and what we&apos;re doing to keep it safe. It
            also tells you about your rights and choices with respect to your Personal Information, and how you can <a
                href="https://xpni.cn/contact"
                target="_blank"
                rel="noopener noreferrer"
            >contact us</a> if you have any questions or concerns.
        </p>
        <h2>What Information Does xpniBlock Collect About Me?</h2>
        <p>
            For the purpose of this Privacy Policy, &ldquo;Information&rdquo; means any information relating to an
            identified or identifiable individual. The xpniBlock App automatically collects and stores locally the
            following Information through its telemetry system: the title of your project in text form, language
            setting, time zone and events related to your use of the xpniBlock App (namely when the xpniBlock App was
            opened and closed, if a project file has been loaded or saved, or if a new project is created). If you
            choose to turn on the telemetry sharing feature, the xpniBlock App will transmit this information to xpniBlock.
            Projects created in the xpniBlock App are not transmitted to or accessible by xpniBlock.
        </p>
        <h2>How Does xpniBlock Use My Information?</h2>
        <p>We use this Information for the following purposes:</p>
        <ul>
            <li>
                <b>Analytics and Improving the xpniBlock App</b> - We use the Information to analyze use of the xpniBlock
                App and to enhance your learning experience on the xpniBlock App.
            </li>
            <li>
                <b>Legal</b> - We may use your Information to enforce our <a
                    href="https://xpni.cn/terms-of-use"
                    target="_blank"
                    rel="noopener noreferrer"
                >Terms of Use</a>, to defend our legal rights, and to comply with our legal obligations and internal
                policies. We may do this by analyzing your use of the xpniBlock App.
            </li>
        </ul>
        ...
        <p>
            ...
            (if you choose to allow the xpniBlock App to send the xpniBlock team your Information) to create, analyze and
            share your aggregated or de-identified Information for research purposes, to analyze and enhance your
            learning experience on the xpniBlock App and otherwise ensure and improve the safety, security, and
            performance of the xpniBlock App. We only rely on our or a third party's legitimate interests to process your
            Information when these interests are not overridden by your rights and interests.
        </p>
        <h2>How Does xpniBlock Share My Information?</h2>
        <p>
            We disclose information that we collect through the xpniBlock App to third parties in the following
            circumstances:
        </p>
        <ul>
            <li>
        ...
        <p>
            The xpniBlock Team is a nonprofit organization. As such, the Children&apos;s Online Privacy
            Protection Act (COPPA) does not apply to xpniBlock. Nevertheless, xpniBlock takes children&apos;s privacy
            seriously. xpniBlock collects only minimal information from its users, and only uses and discloses
            information to provide the services and for limited other purposes, such as research, as described in this
            Privacy Policy.
        </p>
        <p>
            xpniBlock does not collect information from a student&apos;s education record, as defined by the Family
            Educational Rights and Privacy Act (FERPA). xpniBlock does not disclose information of students to any third
        ...
        <ul>
            ...
            <li>
                ...
                provided in a contract between xpniBlock and you, or (iii) if we have a compelling reason to do so (such
        ...
        <h2>How Does xpniBlock Protect My Information?</h2>
        <p>
            xpniBlock has in place administrative, physical, and technical procedures that are intended to protect the
            Information we collect on the xpniBlock App against accidental or unlawful destruction, accidental loss,
        ...
        <p>
            ...
            the China. (where our xpniBlock servers are located) or any other country in which we or our service
        ...
        <p>
            ...
            revised. Your continued use of the xpniBlock App following these changes means that you accept the revised
            Privacy Policy.
        </p>
        <h2>Contact Us</h2>
        <p>
            The xpniBlock Team is the entity responsible for the processing of your Information. If you have any
